...
<div class="container">
    ...
    <form action="/khach-hang/update/${khachHang.id}" method="post">
        <div class="form-group">
            ...
            <input type="text" id="maKhachHang" name="maKhachHang" class="form-control" value="${khachHang.maKhachHang}" readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="trangThai" name="tt">
                ...
                <option value="0" ${khachHang.trangThai == 0 ? 'selected' : ''}>Ngừng hoạt động</option>
            </select>
        </div>
